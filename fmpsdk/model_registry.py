...
ENDPOINT_MODEL_MAP = {
    ...
    "price_target_latest_news": RootModel[List[FMPNewsArticle]],
    ...
    "grades_latest_news": RootModel[List[FMPNewsArticle]],
    # Calendar
    ...
    "batch_mutual_fund_quote": RootModel[List[FMPBulkEOD]],
    "batch_etf_quote": RootModel[List[FMPBulkEOD]],
    "batch_commodity_quote": RootModel[List[FMPQuoteFull]],
    "batch_crypto_quote": RootModel[List[FMPQuoteFull]],
    "batch_forex_quote": RootModel[List[FMPQuoteFull]],
    "batch_index_quote": RootModel[List[FMPQuoteFull]],
    # SEC Filings
