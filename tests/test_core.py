...
class TestCoreFunctionality:
    ...
    def test_fmpsdk_import(self):
        ...
        assert hasattr(fmpsdk, 'general')
        assert hasattr(fmpsdk, 'stock_time_series')
        assert hasattr(fmpsdk, 'company_valuation')
    ...
    def test_module_imports(self):
        ...
        modules_to_test = [
            'general', 'stock_time_series', 'company_valuation',
            'news', 'forex', 'cryptocurrencies', 'etf',
            'insider_trading', 'calendar', 'economic_indicators'
        ]
