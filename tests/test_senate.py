...
class TestParameterizedSenateTradesNames:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "Nancy Pelosi",
            "Elizabeth Warren",
            "Mitt Romney",  # Full names
            "InvalidName",
            "FakePerson",
            "NonExistent",  # Invalid names
            "",
            "   ",
            "123",
...
class TestParameterizedSenateTradesSymbols:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "BRK.B",
            "SPY",
            "QQQ",  # Special characters and ETFs
            "A",
            "T",
            "F",
            "C",
...
class TestParameterizedHouseTradesNames:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "Nancy Pelosi",
            "Kevin McCarthy",
            "Jim Jordan",  # Full names
            "Alexandria Ocasio-Cortez",
            "Matt Gaetz",  # Hyphenated names
            "InvalidName",
            "FakePerson",
            "NonExistent",  # Invalid names
            "",
...
class TestParameterizedHouseTradesSymbols:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "UNH",
            "ABBV",
            "MRK",  # Healthcare stocks
            "BRK.A",
            "BRK.B",
            "BRK-A",
            "BRK-B",  # Special characters
            "V",
            "MA",
            "WM",
            "HD",
...
class TestSenateIntegration:
    ...
    def test_symbol_correlation_workflow(self):
        ...
        for symbol in symbols:
            ...
            senate_symbol_trades = senate.senate_trades_by_symbol(
                apikey=API_KEY, symbol=symbol
            )
            assert senate_symbol_trades is not None

            # 2. Get house trades by symbol
            house_symbol_trades = senate.house_trades_by_symbol(
                apikey=API_KEY, symbol=symbol
            )
